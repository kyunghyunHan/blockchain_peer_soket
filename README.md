...
하지만 둘을 구분 짓자면 프라이빗 블록체인은 네트워크에 참여할 수 있는 사람들을 제한하여 하나의 기관에서 독자적으로 사용하는 블록체인 망을 구성하는 반면, 컨소시엄 블록체인은 같은 목적을 가지고 있는 여러 기관이 하나의 컨소시엄을 구성하여 공정성과 확장성을 보완하였다. 따라서 다수 참여자의 협의가 필요한 분야에서는 컨소시엄 블록체인이 프라이빗 블록체인보다 효과적
